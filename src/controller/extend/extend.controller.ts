...
export class ExtendController {
    ...
    async getExtendDataFromGraph(
        ...
        return await this._extendService.getExtendDataFromGraph(graphURI, entityClass, entityUris, region, page, limit);
    }
}
